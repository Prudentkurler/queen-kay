...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    image: '/products/smart-fitness-watch.jpg',
    category: 'Electronics',
  ...
  // In-stock Products
  {
    ...
    price: 79.99,
    originalPrice: 99.99,
    image: '/products/wireless-earbuds-2.jpg',
    category: 'Electronics',
  ...
  },
  {
    ...
    price: 59.99,
    originalPrice: 89.99,
    image: '/products/organic-set.jpg',
  ...
  },
  {
    ...
    price: 39.99,
    originalPrice: 59.99,
    image: '/products/wireless-bluetooth-speaker.jpg',
    category: 'Electronics',
